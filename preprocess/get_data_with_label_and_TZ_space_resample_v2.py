...
if __name__ == "__main__":
    ...
    output_dir = "./data/12-25-信息文管室内地磁数据采集/12-25-Xiaomi 14/12-25-信息/resample"
    get_save_data_with_label_and_resample_csv(input_dir, output_dir, trans=True, zscore=False)
