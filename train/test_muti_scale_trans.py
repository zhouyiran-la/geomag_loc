...
def test(
    ...
    *,
    ...
    file_name = f"MST_test3_loc_res_meanerr_{mean_l2:.4f}.csv"
...
if __name__ == "__main__":
    ...
    # 改成你实际训练得到的最优权重
    ckpt_path = Path("checkpoints") / "multi_scale_transformer" / "time_mixer_enc_loc_best_20260402_1711_rmse_2d_0.953_xinxi.pt"
