...
def test(
    ...
    *,
    ...
    file_name = f"HLSTM_test3_loc_res_meanerr_{mean_l2:.4f}.csv"
...
if __name__ == "__main__":
    ...
    # 改成你实际训练得到的最优模型路径
    ckpt_path = Path("checkpoints") / "hlstm" / "mag_localization_hlstm_best_20260401_0000_rmse_2d_1.500_wenguan.pt"
